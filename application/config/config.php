...
|
*/
$config['encryption_key'] = 'lv4PfLSVNmtKS4H6YFmpcKCDlGq4yelY';
...
$config['sess_cookie_name'] = env('SESSION_COOKIE');
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = empty(env('SESSION_PATH')) ? null : env('SESSION_PATH');
