                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        ...
                                        <a href="mailto:<?= $this->config->item('admin_email') ?>">administrator</a>
                                    </p>
                                    ...
                                    <table style="<?php echo $style['body_action'] ?>" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="<?php echo site_url('auth/password/reset/' . $token); ?>"
                                            ...
                                            <td style="<?php echo $fontFamily ?>">
                                                ...
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    <a style="<?php echo $style['anchor'] ?>"
                                                       href="<?= site_url('auth/password/reset/' . $token); ?>"
                                                       target="_blank">
                                                        <?= site_url('auth/password/reset/' . $token) ?>
                                                    </a>
                                                </p>

                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    This email was intended for
                                                    <a href="mailto:<?= $user['email'] ?>" style="<?php echo $style['anchor'] ?>">
                                                        <?= $user['email'] ?>
                                                    </a>
                                                </p>
                                            </td>
