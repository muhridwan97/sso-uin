...
<div class="container content-wrapper">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            ...
            <form action="<?= site_url('manage/role/save') ?>" method="post" id="form-role">
                <?= _csrf() ?>
                <p class="form-section-title">Role Access</p>
                <div class="form-group">
                    <label for="role">Role</label>
                    <input type="text" class="form-control" id="role" name="role"
                           placeholder="Role name" maxlength="50" value="<?= set_value('role') ?>">
                    <?= form_error('role') ?>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success my-4" data-toggle="one-touch" data-touch-message="Saving...">Create Role</button>
            </form>
        </div>
    </div>
</div>
