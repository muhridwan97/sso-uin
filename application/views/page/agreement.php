<div class="panel-body">
    ...
    <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms
        ...
        <a href="https://termsfeed.com" rel="nofollow">TermsFeed</a> for <?= $this->config->item('app_name') ?>.</p>
    ...
    <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by
        <?= $this->config->item('app_name') ?>.</p>

    <p><?= $this->config->item('app_name') ?> has no control over, and assumes no responsibility for, the content, privacy policies, or practices of
        any third party web sites or services. You further acknowledge and agree that <?= $this->config->item('app_name') ?> shall not be responsible or
